...
data class Product(val index: Int, val code: String, val name: String, val amount: Float, val unit: String, val price: Long, val tax: Long, val barcode: String)
...
data class HtmlProduct(val index: String, val code: String, val name: String, val amount: String, val unit: String, val price: String, val tax: String, val barcode: String)